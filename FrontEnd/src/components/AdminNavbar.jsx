    ...
    <nav className="bg-white shadow sticky top-0 z-40">
      ...
      {menuOpen && (
        <div className="md:hidden border-t px-4 py-3 flex flex-col gap-1">
          <NavLink to="/admin" end className={mobileLinkClass} onClick={() => setMenuOpen(false)}>
            Dashboard
          </NavLink>
          <NavLink to="/admin/cars" className={mobileLinkClass} onClick={() => setMenuOpen(false)}>
            Cars
          </NavLink>
          <NavLink to="/admin/orders" className={mobileLinkClass} onClick={() => setMenuOpen(false)}>
            Orders
          </NavLink>
          <NavLink to="/admin/inquiries" className={mobileLinkClass} onClick={() => setMenuOpen(false)}>
            Inquiries
          </NavLink>
