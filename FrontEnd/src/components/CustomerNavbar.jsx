...
function CustomerNavbar() {
  ...
  const linkClass = ({ isActive }) =>
    `px-3 py-2 rounded text-sm font-medium ${isActive ? 'bg-purple-600 text-white' : 'text-gray-600 hover:bg-gray-200'
    }`

  const mobileLinkClass = ({ isActive }) =>
    `block px-3 py-2 rounded text-sm font-medium ${isActive ? 'bg-purple-600 text-white' : 'text-gray-600 hover:bg-gray-200'
    }`
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-gray-700 text-white px-3 py-2 rounded text-sm hover:bg-gray-800"
                  >
                    Login
                  </button>
                  <button
